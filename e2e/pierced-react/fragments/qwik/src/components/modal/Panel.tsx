...
import { uwu } from './preventDefault.js';
...
export const HModalPanel = component$((props: PropsOf<'dialog'>) => {
  ...
  return (
    <dialog
      ...
      data-open={context.showSig.value ? 'true' : undefined}
      data-closed={!context.showSig.value ? 'true' : undefined}
    ...
    >
      {context.showSig.value && <script dangerouslySetInnerHTML={uwu} />}
      <Slot />
    </dialog>
  );
});
